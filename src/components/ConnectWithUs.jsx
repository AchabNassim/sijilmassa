...
const ConnectWithUs = () => (
  <section className="w-full flex items-center justify-center py-24">
    <div className="flex flex-row items-stretch justify-center w-full max-w-6xl h-[420px] rounded-3xl shadow-2xl border border-[color:var(--color-green-700)] overflow-hidden bg-[color:var(--color-green-800)]">
      <div className="flex flex-col justify-center items-start px-8 md:px-16 py-10 w-full max-w-2xl">
        ...
        <a
          href="mailto:info@kaabamecca.com"
      ...
      <div className="flex items-center justify-center w-full max-w-md h-full">
        <img src="./imgs/connect.jpg" alt="Connect with us" className="h-full w-auto object-cover rounded-none shadow-none border-0" />
      </div>
    </div>
  </section>
);
